		                ...
		                <div className="box-body">
		                  ...
		                  <div className="input-group input-group-lg">
		                    <div className="input-group-btn">
		                      <button type="button" className="btn btn-warning dropdown-toggle" data-toggle="dropdown">Action <span className="fa fa-caret-down"></span></button>
		                  ...
		                  <div className="input-group input-group-sm">
		                    ...
		                    <span className="input-group-btn">
		                      <button className="btn btn-info btn-flat" type="button">Go!</button>
		                    </span>
		                  </div>
		                </div>
		              </div>
		                ...
		                <div className="box-body">
		                  <form role="form">
		                    ...
		                    <div className="form-group has-warning">
		                      <label className="control-label" for="inputWarning"><i className="fa fa-bell-o"></i> Input with warning</label>
		                      <input type="text" className="form-control" id="inputWarning" placeholder="Enter ..."/>
		                    </div>
		                    <div className="form-group has-error">
		                      <label className="control-label" for="inputError"><i className="fa fa-times-circle-o"></i> Input with error</label>
