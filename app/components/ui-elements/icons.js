                          ...
                          <div className="tab-pane active" id="fa-icons">
                            <section id="new">
                              ...
                              <div className="row fontawesome-icon-list">
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-battery-0"></i> fa-battery-0 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-battery-1"></i> fa-battery-1 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-battery-2"></i> fa-battery-2 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-battery-3"></i> fa-battery-3 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-battery-4"></i> fa-battery-4 <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-battery-three-quarters"></i> fa-battery-three-quarters</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-black-tie"></i> fa-black-tie</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-calendar-check-o"></i> fa-calendar-check-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-calendar-minus-o"></i> fa-calendar-minus-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-calendar-plus-o"></i> fa-calendar-plus-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-calendar-times-o"></i> fa-calendar-times-o</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-creative-commons"></i> fa-creative-commons</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-grab-o"></i> fa-hand-grab-o <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-stop-o"></i> fa-hand-stop-o <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass"></i> fa-hourglass</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-1"></i> fa-hourglass-1 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-2"></i> fa-hourglass-2 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-3"></i> fa-hourglass-3 <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-internet-explorer"></i> fa-internet-explorer</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-odnoklassniki-square"></i> fa-odnoklassniki-square</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-tv"></i> fa-tv <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-yc"></i> fa-yc <span className="text-muted">(alias)</span></div>
                              </div>
                            </section>
                            <section id="web-application">
                              ...
                              <div className="row fontawesome-icon-list">
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-automobile"></i> fa-automobile <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-balance-scale"></i> fa-balance-scale</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-ban"></i> fa-ban</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-bank"></i> fa-bank <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-bar-chart"></i> fa-bar-chart</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-bar-chart-o"></i> fa-bar-chart-o <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-cab"></i> fa-cab <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-down"></i> fa-caret-square-o-down</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-left"></i> fa-caret-square-o-left</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-right"></i> fa-caret-square-o-right</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-up"></i> fa-caret-square-o-up</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-clone"></i> fa-clone</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-close"></i> fa-close <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-dashboard"></i> fa-dashboard <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-edit"></i> fa-edit <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-exclamation-circle"></i> fa-exclamation-circle</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-exclamation-triangle"></i> fa-exclamation-triangle</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-external-link"></i> fa-external-link</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-external-link-square"></i> fa-external-link-square</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-feed"></i> fa-feed <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-movie-o"></i> fa-file-movie-o <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-pdf-o"></i> fa-file-pdf-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-photo-o"></i> fa-file-photo-o <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-picture-o"></i> fa-file-picture-o <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-sound-o"></i> fa-file-sound-o <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-zip-o"></i> fa-file-zip-o <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-fire-extinguisher"></i> fa-fire-extinguisher</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-flash"></i> fa-flash <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-gear"></i> fa-gear <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-gears"></i> fa-gears <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-group"></i> fa-group <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-grab-o"></i> fa-hand-grab-o <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-lizard-o"></i> fa-hand-lizard-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-paper-o"></i> fa-hand-paper-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-peace-o"></i> fa-hand-peace-o</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hotel"></i> fa-hotel <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass"></i> fa-hourglass</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-1"></i> fa-hourglass-1 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-2"></i> fa-hourglass-2 <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-3"></i> fa-hourglass-3 <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-hourglass-start"></i> fa-hourglass-start</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-i-cursor"></i> fa-i-cursor</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-image"></i> fa-image <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-institution"></i> fa-institution <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-legal"></i> fa-legal <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-life-bouy"></i> fa-life-bouy <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-life-buoy"></i> fa-life-buoy <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-life-ring"></i> fa-life-ring</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-life-saver"></i> fa-life-saver <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-mail-forward"></i> fa-mail-forward <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-mail-reply"></i> fa-mail-reply <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-mail-reply-all"></i> fa-mail-reply-all <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-microphone-slash"></i> fa-microphone-slash</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-mobile-phone"></i> fa-mobile-phone <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-mortar-board"></i> fa-mortar-board <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-navicon"></i> fa-navicon <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-photo"></i> fa-photo <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-registered"></i> fa-registered</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-remove"></i> fa-remove <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-reorder"></i> fa-reorder <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-send"></i> fa-send <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-send-o"></i> fa-send-o <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-share-alt-square"></i> fa-share-alt-square</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-soccer-ball-o"></i> fa-soccer-ball-o <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-sort-amount-desc"></i> fa-sort-amount-desc</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-sort-down"></i> fa-sort-down <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-sort-numeric-asc"></i> fa-sort-numeric-asc</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-sort-numeric-desc"></i> fa-sort-numeric-desc</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-sort-up"></i> fa-sort-up <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-star-half-empty"></i> fa-star-half-empty <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-star-half-full"></i> fa-star-half-full <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-support"></i> fa-support <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-down"></i> fa-toggle-down <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-left"></i> fa-toggle-left <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-right"></i> fa-toggle-right <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-up"></i> fa-toggle-up <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-trademark"></i> fa-trademark</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-unsorted"></i> fa-unsorted <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-warning"></i> fa-warning <span className="text-muted">(alias)</span></div>
                            ...
                            <section id="gender">
                              ...
                              <div className="row fontawesome-icon-list">
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-genderless"></i> fa-genderless</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-intersex"></i> fa-intersex <span className="text-muted">(alias)</span></div>
                            ...
                            <section id="currency">
                              ...
                              <div className="row fontawesome-icon-list">
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-bitcoin"></i> fa-bitcoin <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-btc"></i> fa-btc</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-cny"></i> fa-cny <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-dollar"></i> fa-dollar <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-eur"></i> fa-eur</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-euro"></i> fa-euro <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-money"></i> fa-money</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-rmb"></i> fa-rmb <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-rouble"></i> fa-rouble <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-rub"></i> fa-rub</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-ruble"></i> fa-ruble <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-rupee"></i> fa-rupee <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-shekel"></i> fa-shekel <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-sheqel"></i> fa-sheqel <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-try"></i> fa-try</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-turkish-lira"></i> fa-turkish-lira <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-usd"></i> fa-usd</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-won"></i> fa-won <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-yen"></i> fa-yen <span className="text-muted">(alias)</span></div>
                              </div>
                            </section>
                            ...
                            <section id="text-editor">
                              ...
                              <div className="row fontawesome-icon-list">
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-chain"></i> fa-chain <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-copy"></i> fa-copy <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-cut"></i> fa-cut <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-dedent"></i> fa-dedent <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-eraser"></i> fa-eraser</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file"></i> fa-file</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-o"></i> fa-file-o</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-file-text"></i> fa-file-text</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-paste"></i> fa-paste <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-repeat"></i> fa-repeat</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-rotate-left"></i> fa-rotate-left <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-rotate-right"></i> fa-rotate-right <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-save"></i> fa-save <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-unlink"></i> fa-unlink <span className="text-muted">(alias)</span></div>
                              </div>
                            </section>
                            ...
                            <section id="directional">
                              ...
                              <div className="row fontawesome-icon-list">
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-down"></i> fa-angle-double-down</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-left"></i> fa-angle-double-left</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-right"></i> fa-angle-double-right</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-down"></i> fa-arrow-circle-down</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-left"></i> fa-arrow-circle-left</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-down"></i> fa-arrow-circle-o-down</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-left"></i> fa-arrow-circle-o-left</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-right"></i> fa-arrow-circle-o-right</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-up"></i> fa-arrow-circle-o-up</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-right"></i> fa-arrow-circle-right</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-down"></i> fa-chevron-circle-down</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-left"></i> fa-chevron-circle-left</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-right"></i> fa-chevron-circle-right</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-up"></i> fa-chevron-circle-up</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-long-arrow-right"></i> fa-long-arrow-right</div>
                            ...
                            <section id="brand">
                              ...
                              <div className="row fontawesome-icon-list">
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-bitbucket-square"></i> fa-bitbucket-square</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-bitcoin"></i> fa-bitcoin <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-black-tie"></i> fa-black-tie</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-btc"></i> fa-btc</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-facebook-f"></i> fa-facebook-f <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-facebook-official"></i> fa-facebook-official</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-ge"></i> fa-ge <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-get-pocket"></i> fa-get-pocket</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-gg"></i> fa-gg</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-gg-circle"></i> fa-gg-circle</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-gittip"></i> fa-gittip <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-google-plus-square"></i> fa-google-plus-square</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-google-wallet"></i> fa-google-wallet</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-pinterest-square"></i> fa-pinterest-square</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-qq"></i> fa-qq</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-ra"></i> fa-ra <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-stumbleupon-circle"></i> fa-stumbleupon-circle</div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-wechat"></i> fa-wechat <span className="text-muted">(alias)</span></div>
                                ...
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-y-combinator"></i> fa-y-combinator</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-y-combinator-square"></i> fa-y-combinator-square <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-yahoo"></i> fa-yahoo</div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-yc"></i> fa-yc <span className="text-muted">(alias)</span></div>
                                <div className="col-md-3 col-sm-4"><i className="fa fa-fw fa-yc-square"></i> fa-yc-square <span className="text-muted">(alias)</span></div>
                          ...
                          <div className="tab-pane" id="glyphicons">
                            <ul className="bs-glyphicons">
                              <li>
                                ...
                                <span className="glyphicon-className">glyphicon glyphicon-asterisk</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-plus"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-plus</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-euro"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-euro</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-eur"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-eur</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-minus"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-minus</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-cloud"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-cloud</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-envelope"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-envelope</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-pencil"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-pencil</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-glass"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-glass</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-music"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-music</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-search"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-search</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-heart"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-heart</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-star"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-star</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-star-empty"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-star-empty</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-user"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-user</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-film"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-film</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-th-large"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-th-large</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-th"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-th</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-th-list"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-th-list</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ok"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ok</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-remove"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-remove</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-zoom-in"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-zoom-in</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-zoom-out"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-zoom-out</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-off"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-off</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-signal"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-signal</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-cog"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-cog</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-trash"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-trash</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-home"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-home</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-file"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-file</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-time"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-time</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-road"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-road</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-download-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-download-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-download"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-download</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-upload"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-upload</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-inbox"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-inbox</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-play-circle"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-play-circle</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-repeat"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-repeat</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-refresh"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-refresh</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-list-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-list-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-lock"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-lock</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-flag"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-flag</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-headphones"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-headphones</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-volume-off"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-volume-off</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-volume-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-volume-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-volume-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-volume-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-qrcode"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-qrcode</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-barcode"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-barcode</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tag"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tag</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tags"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tags</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-book"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-book</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bookmark"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bookmark</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-print"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-print</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-camera"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-camera</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-font"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-font</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bold"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bold</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-italic"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-italic</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-text-height"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-text-height</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-text-width"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-text-width</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-align-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-align-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-align-center"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-align-center</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-align-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-align-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-align-justify"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-align-justify</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-list"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-list</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-indent-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-indent-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-indent-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-indent-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-facetime-video"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-facetime-video</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-picture"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-picture</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-map-marker"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-map-marker</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-adjust"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-adjust</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tint"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tint</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-edit"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-edit</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-share"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-share</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-check"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-check</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-move"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-move</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-step-backward"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-step-backward</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-fast-backward"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-fast-backward</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-backward"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-backward</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-play"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-play</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-pause"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-pause</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-stop"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-stop</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-forward"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-forward</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-fast-forward"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-fast-forward</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-step-forward"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-step-forward</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-eject"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-eject</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-chevron-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-chevron-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-chevron-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-chevron-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-plus-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-plus-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-minus-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-minus-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-remove-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-remove-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ok-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ok-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-question-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-question-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-info-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-info-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-screenshot"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-screenshot</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-remove-circle"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-remove-circle</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ok-circle"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ok-circle</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ban-circle"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ban-circle</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-arrow-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-arrow-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-arrow-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-arrow-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-arrow-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-arrow-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-arrow-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-arrow-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-share-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-share-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-resize-full"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-resize-full</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-resize-small"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-resize-small</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-exclamation-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-exclamation-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-gift"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-gift</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-leaf"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-leaf</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-fire"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-fire</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-eye-open"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-eye-open</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-eye-close"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-eye-close</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-warning-sign"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-warning-sign</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-plane"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-plane</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-calendar"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-calendar</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-random"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-random</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-comment"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-comment</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-magnet"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-magnet</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-chevron-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-chevron-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-chevron-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-chevron-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-retweet"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-retweet</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-shopping-cart"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-shopping-cart</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-folder-close"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-folder-close</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-folder-open"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-folder-open</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-resize-vertical"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-resize-vertical</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-resize-horizontal"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-resize-horizontal</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hdd"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hdd</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bullhorn"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bullhorn</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bell"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bell</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-certificate"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-certificate</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-thumbs-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-thumbs-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-thumbs-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-thumbs-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hand-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hand-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hand-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hand-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hand-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hand-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hand-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hand-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-circle-arrow-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-circle-arrow-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-circle-arrow-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-circle-arrow-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-circle-arrow-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-circle-arrow-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-circle-arrow-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-circle-arrow-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-globe"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-globe</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-wrench"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-wrench</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tasks"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tasks</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-filter"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-filter</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-briefcase"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-briefcase</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-fullscreen"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-fullscreen</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-dashboard"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-dashboard</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-paperclip"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-paperclip</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-heart-empty"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-heart-empty</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-link"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-link</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-phone"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-phone</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-pushpin"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-pushpin</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-usd"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-usd</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-gbp"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-gbp</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort-by-alphabet"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort-by-alphabet</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort-by-alphabet-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort-by-alphabet-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort-by-order"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort-by-order</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort-by-order-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort-by-order-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort-by-attributes"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort-by-attributes</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sort-by-attributes-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sort-by-attributes-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-unchecked"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-unchecked</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-expand"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-expand</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-collapse-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-collapse-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-collapse-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-collapse-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-log-in"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-log-in</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-flash"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-flash</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-log-out"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-log-out</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-new-window"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-new-window</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-record"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-record</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-save"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-save</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-open"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-open</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-saved"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-saved</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-import"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-import</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-export"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-export</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-send"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-send</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-floppy-disk"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-floppy-disk</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-floppy-saved"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-floppy-saved</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-floppy-remove"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-floppy-remove</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-floppy-save"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-floppy-save</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-floppy-open"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-floppy-open</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-credit-card"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-credit-card</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-transfer"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-transfer</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-cutlery"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-cutlery</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-header"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-header</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-compressed"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-compressed</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-earphone"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-earphone</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-phone-alt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-phone-alt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tower"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tower</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-stats"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-stats</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sd-video"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sd-video</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hd-video"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hd-video</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-subtitles"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-subtitles</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sound-stereo"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sound-stereo</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sound-dolby"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sound-dolby</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sound-5-1"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sound-5-1</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sound-6-1"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sound-6-1</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sound-7-1"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sound-7-1</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-copyright-mark"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-copyright-mark</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-registration-mark"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-registration-mark</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-cloud-download"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-cloud-download</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-cloud-upload"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-cloud-upload</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tree-conifer"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tree-conifer</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tree-deciduous"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tree-deciduous</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-cd"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-cd</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-save-file"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-save-file</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-open-file"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-open-file</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-level-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-level-up</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-copy"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-copy</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-paste"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-paste</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-alert"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-alert</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-equalizer"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-equalizer</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-king"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-king</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-queen"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-queen</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-pawn"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-pawn</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bishop"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bishop</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-knight"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-knight</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-baby-formula"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-baby-formula</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-tent"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-tent</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-blackboard"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-blackboard</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bed"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bed</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-apple"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-apple</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-erase"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-erase</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-hourglass"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-hourglass</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-lamp"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-lamp</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-duplicate"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-duplicate</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-piggy-bank"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-piggy-bank</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-scissors"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-scissors</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-bitcoin"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-bitcoin</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-btc"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-btc</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-xbt"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-xbt</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-yen"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-yen</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-jpy"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-jpy</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ruble"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ruble</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-rub"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-rub</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-scale"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-scale</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ice-lolly"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ice-lolly</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-ice-lolly-tasted"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-ice-lolly-tasted</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-education"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-education</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-option-horizontal"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-option-horizontal</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-option-vertical"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-option-vertical</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-menu-hamburger"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-menu-hamburger</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-modal-window"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-modal-window</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-oil"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-oil</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-grain"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-grain</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-sunglasses"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-sunglasses</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-text-size"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-text-size</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-text-color"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-text-color</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-text-background"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-text-background</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-object-align-top"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-object-align-top</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-object-align-bottom"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-object-align-bottom</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-object-align-horizontal"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-object-align-horizontal</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-object-align-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-object-align-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-object-align-vertical"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-object-align-vertical</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-object-align-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-object-align-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-triangle-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-triangle-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-triangle-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-triangle-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-triangle-bottom"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-triangle-bottom</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-triangle-top"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-triangle-top</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-console"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-console</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-superscript"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-superscript</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-subscript"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-subscript</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-menu-left"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-menu-left</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-menu-right"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-menu-right</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-menu-down"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-menu-down</span>
                              </li>
                              <li>
                                <span className="glyphicon glyphicon-menu-up"></span>
                                <span className="glyphicon-className">glyphicon glyphicon-menu-up</span>
                              </li>
                            </ul>
                          </div>{/*<!-- /#ion-icons -->*/}
