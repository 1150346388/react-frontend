...
export default class ReadMail extends React.Component {
    getInitialState() {
		              ...
		              <div className="box box-primary">
		                ...
		                <div className="box-footer">
		                  <ul className="mailbox-attachments clearfix">
		                    ...
		                    <li>
		                      <span className="mailbox-attachment-icon has-img"><img src={photo1} alt="Attachment"/></span>
		                      <div className="mailbox-attachment-info">
		                    ...
		                    <li>
		                      <span className="mailbox-attachment-icon has-img"><img src={photo2} alt="Attachment"/></span>
		                      <div className="mailbox-attachment-info">
