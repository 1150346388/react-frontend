...
import HeaderBar from '../HeaderBar/header-bar';
...
//import WorldMap from '../chart/world-map';
...
import ContainerFour from '../containers/container-four';
//import ContainerFive from '../containers/container-five';
import ContainerSix from '../containers/container-six';
import ContainerSeven from '../containers/container-seven';
import ControlsMenu from '../controlsMenu/controls-menu';
import StatTile from '../statTile/stat-tile';
...
export default class Dashboard extends React.Component {
	...
	render() {
		...
		var statTileWidgets = this.state && this.state.statTileOptions && this.state.statTileOptions.map(function(options, iterator) {
			return ( < StatTile key = {
					"rowThree" + iterator
				}
				width = {
