...
export default class Morriss extends React.Component {
    componentDidMount() {
        "use strict";
            ...
            <div className="content-wrapper">
                ...
                <section className="content">
                    ...
                    <div className="row">
                        ...
                        <div className="box-body chart-responsive">
                            <div className="chart" id="sales-chart" style={{height: 300,position: 'relative'}}></div>
                        </div>{/* /.box-body */}
                        </div>{/* /.box */}
                    </div>{/* /.col (LEFT) */}
                    <div className="col-md-6">
                        ...
                        <div className="box box-success">
                            ...
                            <div className="box-body chart-responsive">
                                <div className="chart" id="bar-chart" style={{height: 300}}></div>
                            </div>{/* /.box-body */}
                            </div>{/* /.box */}
                        </div>{/* /.col (RIGHT) */}
                    </div>{/* /.row */}
